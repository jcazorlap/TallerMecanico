...
public interface IClientes {
    ...
    default void insertar(Cliente cliente) {
        if (cliente == null) {
    ...
    default Cliente modificar(Cliente cliente, String nombre, String telefono) {
        if (cliente == null) {
    ...
    default Cliente buscar(Cliente cliente) {
        if (cliente == null) {
    ...
    default void borrar(Cliente cliente) {
        if (cliente == null) {
